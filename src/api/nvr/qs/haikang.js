 ...
 * @param endTime 结束时间
 */
export const queryHaiKangRecord = (
    deviceId,
    channelId,
    startTime,
    endTime
 ...
 * @param data 下载请求
 */
export const downloadHaikangRecordDirect = (data: HaikangRecordDownloadRequest) => {
    return request({
 ...
 */
export const captureHaikangAndSave = (
    deviceId,
    channelId,
    snapshotType = 'manual'
) => {
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangDeviceInfo = (
    deviceId
) => {
    return request({
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangStorageInfo = (
    deviceId
) => {
    return request({
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangSDCardInfo = (
    deviceId
) => {
    return request({
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangBitrateInfo = (
    deviceId
) => {
    return request({
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangNetworkStatusInfo = (
    deviceId
) => {
    return request({
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangSoftwareVersionInfo = (
    deviceId
) => {
    return request({
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangRecordStateInfo = (
    deviceId
) => {
    return request({
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangPowerStateInfo = (
    deviceId
) => {
    return request({
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangAlarmArmInfo = (
    deviceId
) => {
    return request({
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangCameraInfo = (
  deviceId
) => {
  return request({
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangRtspUrlInfo = (
  deviceId
) => {
  return request({
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangSystemParam = (
    deviceId
) => {
    return request({
 ...
 */
export const getHaiKangVideoParam = (
    deviceId,
    channelId,
    streamType
) => {
 ...
 * @param deviceId 设备ID
 */
export const getHaiKangDevTime = (
    deviceId
) => {
    return request({
 ...
 */
export const setHaiKangDevTime = (
    deviceId,
    time
) => {
    return request({
 ...
 * @param deviceId 设备ID
 */
export const rebootHaiKangDevice = (
    deviceId
) => {
    return request({

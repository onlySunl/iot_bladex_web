 ...
 * @param endTime 结束时间
 */
export const queryDeviceRecord = (
  deviceId,
  channelId,
  startTime,
  endTime
 ...
 */
export const queryDeviceConfig = (deviceId, configType) => {
  return request({
 ...
 */
export const subscribeCatalog = (qsDeviceId) => {
  return request({
 ...
 * @param qsDeviceId QsDevice主键ID
 */
export const unsubscribeCatalog = (qsDeviceId) => {
  return request({
 ...
 */
export const queryHomePosition = (deviceId, channelId) => {
  return request({
 ...
 * @param config 看守位配置
 */
export const updateHomePosition = (deviceId, channelId, config) => {
  return request({
    url: `/gb28181/device/homePosition/${deviceId}`,
    method: 'post',
    params: { channelId },
 ...
 * @param channelId 通道ID（可选）
 */
export const queryCruiseTrackList = (deviceId, channelId) => {
    return request({
 ...
 */
export const queryCruiseTrack = (deviceId, channelId, number) => {
    return request({
 ...
 * @param channelId 通道ID（可选）
 */
export const queryPTZPosition = (deviceId, channelId) => {
    return request({
 ...
 * @param channelId 通道ID（可选）
 */
export const querySDCardStatus = (deviceId, channelId) => {
    return request({
 ...
 * @param cruiseId 巡航组号
 */
export const startCruise = (deviceId, channelId, cruiseId) => {
    return request({
 ...
 * @param cruiseId 巡航组号
 */
export const stopCruise = (deviceId, channelId, cruiseId) => {
    return request({
 ...
 */
export const alarmResetControl = (deviceId, channelId, alarmMethod, alarmType) => {
    return request({
 ...
 * @param channelId 通道ID（可选）
 */
export const iFrameControl = (deviceId, channelId) => {
    return request({
 ...
 */
export const homePositionControl = (deviceId, channelId, deviceConfig) => {
    return request({
 ...
 */
export const ptzPreciseControl = (deviceId, channelId, ptzPreciseCtrl) => {
    return request({
 ...
 */
export const deviceUpgradeControl = (deviceId, channelId, firmware, fileURL, manufacturer, sessionID) => {
    return request({
 ...
 */
export const formatSDCardControl = (deviceId, channelId, sdCardId) => {
    return request({
 ...
 */
export const targetTrackControl = (deviceId, channelId, targetTrack, deviceId2, targetArea) => {
    return request({

  ...
  <basic-container>
    ...
    >
      <template slot-scope="{ row, type, disabled }" slot="menuForm">
        <script-form ref="formRef" :form-data="form" :type="type" :disabled="disabled" @submit="handleFormSubmit" />
      </template>
    </avue-crud>
  </basic-container>
</template>
...
<script>
import { getList, getDetail, add, update, remove } from '@/api/iot/rule/script'
    ...
    return {
      ...
      option: {
        ...
        },
        {
                ...
                "prop": "scriptType",
                "type": "select",
                "dicUrl": "/api/blade-system/dict/dictionary?code=iot_model_type",
                "props": {
                        "label": "dictValue",
                        "value": "dictKey"
                },

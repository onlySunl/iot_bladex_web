  ...
  <basic-container>
    ...
    >
      <template slot-scope="{ row, type, disabled }" slot="menuForm">
        <scene-form ref="formRef" :form-data="form" :type="type" :disabled="disabled" @submit="handleFormSubmit" />
      </template>
    </avue-crud>
  </basic-container>
</template>
...
<script>
import { getList, getDetail, add, update, remove } from '@/api/iot/rule/scene'
    ...
    return {
      ...
      option: {
        ...
        },
        {
                ...
                "prop": "triggerType",
                "type": "select",
                "dicUrl": "/api/blade-system/dict/dictionary?code=iot_task_status",
                "props": {
                        "label": "dictValue",
                        "value": "dictKey"
                },

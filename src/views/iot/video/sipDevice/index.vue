  ...
  <basic-container>
    ...
    >
      <template slot-scope="{ row, type, disabled }" slot="menuForm">
        <sip-device-form ref="formRef" :form-data="form" :type="type" :disabled="disabled" @submit="handleFormSubmit" />
      </template>
    </avue-crud>
  </basic-container>
</template>
...
<script>
import { getList, getDetail, add, update, remove } from '@/api/iot/video/sip-device'
import SipDeviceForm from './sip-device-form'

export default {
  name: 'SipDevicePage',
  components: { SipDeviceForm },
  data() {
    return {
      form: {},
      tableData: [],

            ...
            <template #default="scope">
               <div class="table-actions">
                  <el-tooltip content="修改">
                     <el-button type="primary" text bg size="small" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:menu:edit']"></el-button>
                  </el-tooltip>
                  <el-tooltip content="新增">
                     <el-button type="success" text bg size="small" icon="Plus" @click="handleAdd(scope.row)" v-hasPermi="['system:menu:add']"></el-button>
                  </el-tooltip>
                  <el-tooltip content="删除">
                     <el-button type="danger" text bg size="small" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:menu:remove']"></el-button>
                  </el-tooltip>
               </div>
            </template>
         </el-table-column>

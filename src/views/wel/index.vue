        ...
        <el-row>
          <basic-container>
            <el-collapse v-model="logActiveNames" @change="handleChange">
              <el-collapse-item title="4.8.0.RELEASE发布，新增超级令牌认证，新增签名防重放攻击，新增请求规则配置" name="44">
              ...
              <el-collapse-item title="4.7.0.RELEASE发布，升级支持SpringBoot3.5.6，新增国际化，新增字段入库加解密" name="43">
              ...
              <el-collapse-item title="4.6.0.RELEASE发布，新增KingBase兼容支持，新增数据审计模块，新增接口防抖工具" name="42">
              ...
              <el-collapse-item title="4.5.0.RELEASE发布，新增超轻量级规则引擎 LiteRule，重构@PreAuth等底层模块" name="41">
              ...
              <el-collapse-item title="4.4.0.RELEASE发布，新增字段脱敏，前端打包速度+100%，访问速度+200%" name="40">
              ...
              <el-collapse-item title="4.3.0.RELEASE 新版登录主题，重构Xss，代码快速生成接入可视化拖拽表单" name="39">
                ...
                <div>7.[新增]禁用url、白名单、黑名单功能，默认禁用外部ip访问actuator的请求，免去nginx配置</div>
                <div>8.[新增]支持配置是否给超管账号关闭租户过滤的逻辑，默认为超管账号可看到所有租户数据</div>
                <div>9.[新增]@PreAuth("hasMenu('xxx')") 权限配置，支持后端接口与菜单编号的角色权限绑定</div>
                ...
                <div>23.[优化]报文加密逻辑，@ApiDecrypt与@ApiEncrypt默认为AES模式，简化配置参数</div>
                <div>24.[优化]重构WebUtil的getRequestBody与getRequestContent方法逻辑</div>
                <div>25.[优化]代码生成Entity的逻辑，不继承基础类的情况下不限制通用业务字段的生成逻辑</div>
              ...
              <el-collapse-item title="4.2.0.RELEASE 新增对象存储本地模式上传 新增代码生成默认配置与快速生成" name="38">
              ...
              <el-collapse-item title="4.1.0.RELEASE发布，安全认证采用国密算法，新增短信登录，新增token无感刷新" name="37">
